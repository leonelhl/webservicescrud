$(function() {
    ...
    function addTagForm(collectionHolder, $newLinkLi) {
       var func = 'Función';
        ...
        $newFormLi = $('<div id="function' + j + '" class="col-lg-12 well atrib"><hr/><button type="button" value="function' + j + '" class="close">&times;</button><h3>'+func +' # '+ j +' </h3></div>').append(newForm);
        ...
        $('.submenu').append($('<a href="#function' + j + '" class="function' + j + ' list-group-item">'+func +' # '+j+ '</a>'));
