...
class TokenController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('WebServiceBundle:Token')->findAll();

        return $this->render('WebServiceBundle:Token:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('WebServiceBundle:Token:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('WebServiceBundle:Token')->find($id);
        ...
        return $this->render('WebServiceBundle:Token:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('WebServiceBundle:Token:edit.html.twig', array(
            'entity'      => $entity,
